...
export function CardHoverEffect({
  ...
  return (
    <Div
      ...
      className={cn(
        'group relative z-30 w-full cursor-pointer overflow-hidden rounded-2xl h-full',
        sizeConfig.padding,
        // Light mode styles
    ...
    >
      {/* Moving Border */}
      <div
        className="absolute inset-0 overflow-hidden border   rounded-[inherit]"
        style={{
      ...
      >
        <div
          ...
          style={{
            background: `conic-gradient(from 0deg at 50% 50%, transparent 0deg, transparent 340deg, hsl(var(--primary)) 360deg)`,
